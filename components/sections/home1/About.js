                        ...
                        <div className="col-lg-6">
                            <div className="about-content-three">
                                <div className="section-title-two mb-20 tg-heading-subheading animation-style3">
                                    ...
                                    <h2 className="title tg-element-title">Driving Growth Through ICT &amp; Digital Innovation</h2>
                                </div>
                                <p className="info-one">OgaalSan Consultancy helps organizations design and implement modern ICT systems, digital products, and data-driven strategies that unlock new opportunities and improve performance.</p>
                                <div className="about-list-two">
                                    <ul className="list-wrap">
                                        <li><i className="fas fa-arrow-right" />ICT solutions that modernise and secure your systems</li>
                                        <li><i className="fas fa-arrow-right" />Training &amp; capacity building for your teams</li>
                                        <li><i className="fas fa-arrow-right" />Business development and digital product support</li>
                                        <li><i className="fas fa-arrow-right" />Digital marketing to grow your online presence</li>
                                    </ul>
                                </div>
                                <p>From initial discovery to delivery and ongoing optimisation, we work as your long-term partner to ensure technology truly supports your mission and the communities you serve.</p>
