            ...
            <section className="banner-area-two banner-bg-two" data-background="/assets/img/banner/h2_banner_bg.jpg">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="banner-img-wrap" data-aos="fade-left" data-aos-delay={400} style={{ 
                                position: 'relative',
                                width: '100%',
                                height: '500px',
                                display: 'flex',
                ...
                <div className="banner-shape-wrap">
                    <Image src="/assets/img/banner/h2_banner_shape01.png" alt="" width={100} height={100} loading="lazy" />
                    <Image src="/assets/img/banner/h2_banner_shape02.png" alt="" width={100} height={100} loading="lazy" />
                    <Image src="/assets/img/banner/h2_banner_shape03.png" alt="" width={100} height={100} loading="lazy" data-aos="zoom-in-up" data-aos-delay={800} />
                </div>
            </section>
        </>
    )
